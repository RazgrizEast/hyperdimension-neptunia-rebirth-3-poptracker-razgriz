...
function hasGrindLevel20()
    if hasGrindLevel10() == 1 and Tracker:ProviderCountForCode("dungeonunlockbandicrash") == 1 or
       hasGrindLevel10() == 1 and Tracker:ProviderCountForCode("dungeonunlockkuzaratfacility1") == 1 or
       hasGrindLevel10() == 1 and Tracker:ProviderCountForCode("dungeonunlockwandererscave") == 1 or
       hasGrindLevel10() == 1 and Tracker:ProviderCountForCode("dungeonunlockzecaruinsno2") == 1 then
        return 1
    end
    return 0
end
...
function hasGrindLevel30()
    if hasGrindLevel20() == 1 and Tracker:ProviderCountForCode("dungeonunlockcastlechambers") == 1 or
       hasGrindLevel20() == 1 and Tracker:ProviderCountForCode("dungeonunlockloweecastleexterior") == 1 or
       hasGrindLevel20() == 1 and Tracker:ProviderCountForCode("dungeonunlockreloadgrasslands") == 1 or
       hasGrindLevel20() == 1 and Tracker:ProviderCountForCode("dungeonunlockrudarmssewern") == 1 or
       hasGrindLevel20() == 1 and Tracker:ProviderCountForCode("dungeonunlockrudarmssewers") == 1 or
       hasGrindLevel20() == 1 and Tracker:ProviderCountForCode("dungeonunlocksoniwetlands") == 1 then
        return 1
    end
    return 0
end
...
function hasGrindLevel40()
    if hasGrindLevel30() == 1 and Tracker:ProviderCountForCode("dungeonunlockadaldikforest") == 1 or
       hasGrindLevel30() == 1 and Tracker:ProviderCountForCode("dungeonunlockgigomainentrance") == 1 or
       hasGrindLevel30() == 1 and Tracker:ProviderCountForCode("dungeonunlockhaloforest") == 1 or
       hasGrindLevel30() == 1 and Tracker:ProviderCountForCode("dungeonunlocksuahomountainrange") == 1 then
        return 1
    end
    return 0
end
...
function hasGrindLevel50()
    if hasGrindLevel40() == 1 and Tracker:ProviderCountForCode("dungeonunlockmetroidshelter") == 1 or
       hasGrindLevel40() == 1 and Tracker:ProviderCountForCode("dungeonunlockmines") == 1 or
       hasGrindLevel40() == 1 and Tracker:ProviderCountForCode("dungeonunlocknationalfactory") == 1 or
       hasGrindLevel40() == 1 and Tracker:ProviderCountForCode("dungeonunlockpsdimension") == 1 or
       hasGrindLevel40() == 1 and Tracker:ProviderCountForCode("dungeonunlockzegaforest") == 1 then
        return 1
    end
    return 0
end
...
function hasGrindLevel60()
    if hasGrindLevel50() == 1 and Tracker:ProviderCountForCode("dungeonunlocknekutokiforest") == 1 or
       hasGrindLevel50() == 1 and Tracker:ProviderCountForCode("dungeonunlockotoricave") == 1 or
       hasGrindLevel50() == 1 and Tracker:ProviderCountForCode("dungeonunlockanonydeathslab") == 1 or
       hasGrindLevel50() == 1 and Tracker:ProviderCountForCode("dungeonunlockarioplateau") == 1 or
       hasGrindLevel50() == 1 and Tracker:ProviderCountForCode("dungeonunlockhanedamountainrange") == 1 or
       hasGrindLevel50() == 1 and Tracker:ProviderCountForCode("dungeonunlockkeragadimension") == 1 or
       hasGrindLevel50() == 1 and Tracker:ProviderCountForCode("dungeonunlockkobabaruins") == 1 or
       hasGrindLevel50() == 1 and Tracker:ProviderCountForCode("dungeonunlocklujiplateau") == 1 or
       hasGrindLevel50() == 1 and Tracker:ProviderCountForCode("dungeonunlockmagmacave") == 1 then
        return 1
    end
    return 0
end
...
function hasGrindLevel70()
    if hasGrindLevel60() == 1 and Tracker:ProviderCountForCode("dungeonunlockvirtuaforest") == 1 or
       hasGrindLevel60() == 1 and Tracker:ProviderCountForCode("dungeonunlockpowerlevelisland") == 1 or
       hasGrindLevel60() == 1 and Tracker:ProviderCountForCode("dungeonunlockpiishiigamefactory") == 1 or
       hasGrindLevel60() == 1 and Tracker:ProviderCountForCode("dungeonunlockcitycenter") == 1 or
       hasGrindLevel60() == 1 and Tracker:ProviderCountForCode("dungeonunlockextradimensionalspace") == 1 or
       hasGrindLevel60() == 1 and Tracker:ProviderCountForCode("dungeonunlockgraphicpass") == 1 then
        return 1
    end
    return 0
end
...
function hasGrindLevel80()
    if hasGrindLevel70() == 1 and Tracker:ProviderCountForCode("dungeonunlocksoshalforest") == 1 or
       hasGrindLevel70() == 1 and Tracker:ProviderCountForCode("dungeonunlockemesmagmacave") == 1 or
       hasGrindLevel70() == 1 and Tracker:ProviderCountForCode("dungeonunlockloweecastlenorthernspace") == 1 or
       hasGrindLevel70() == 1 and Tracker:ProviderCountForCode("dungeonunlockvidadimension") == 1 then
        return 1
    end
    return 0
end
...
function hasGrindLevel90()
    if hasGrindLevel80() == 1 and Tracker:ProviderCountForCode("dungeonunlockduorruins") == 1 then
        return 1
    end
    return 0
end
