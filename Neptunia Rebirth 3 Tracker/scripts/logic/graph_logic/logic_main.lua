...
hyperdimension_neptunia_rebirth3_v_generation_location = {}
hyperdimension_neptunia_rebirth3_v_generation_location.__index = hyperdimension_neptunia_rebirth3_v_generation_location
...
function hyperdimension_neptunia_rebirth3_v_generation_location.new(name)
    local self = setmetatable({}, hyperdimension_neptunia_rebirth3_v_generation_location)
    if name then
...
function hyperdimension_neptunia_rebirth3_v_generation_location:connect_one_way(exit, rule)
    if type(exit) == "string" then
        ...
        if existing then
            ...
            exit = hyperdimension_neptunia_rebirth3_v_generation_location.new(exit)
        end
    end
    if rule == nil then
        rule = always
...
function hyperdimension_neptunia_rebirth3_v_generation_location:connect_two_ways(exit, rule)
...
function hyperdimension_neptunia_rebirth3_v_generation_location:connect_one_way_entrance(name, exit, rule)
    if rule == nil then
        rule = always
    end
    self.exits[#self.exits + 1] = { exit, rule }
...
function hyperdimension_neptunia_rebirth3_v_generation_location:connect_two_ways_entrance(name, exit, rule)
...
-- acts as a shortcut for 2 connect_one_way_entrance-calls
function hyperdimension_neptunia_rebirth3_v_generation_location:connect_two_ways_entrance_door_stuck(name, exit, rule1, rule2)
...
function hyperdimension_neptunia_rebirth3_v_generation_location:connect_two_ways_stuck(exit, rule1, rule2)
...
function hyperdimension_neptunia_rebirth3_v_generation_location:accessibility()
...
-- 
function hyperdimension_neptunia_rebirth3_v_generation_location:discover(accessibility, keys)
...
entry_point = hyperdimension_neptunia_rebirth3_v_generation_location.new("entry_point")
